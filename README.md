...
This method is a new oversampling algorithm and can circumvent the deficiency of SMOTE as well as its variants caused by randomly selecting some minority class samples.
